...
const { getAllConversationsByUserId, getConversationById } = require("./controllers/conversation.controller.js");
...
router.get("/conversations", validateUserIsAuthenticated,  getAllConversationsByUserId);

router.get("/conversations/create", validateUserIsAuthenticated,  getAllConversationsByUserId); // create a conversation

router.get("/conversations/:conversationId", validateUserIsAuthenticated,  getConversationById); // get a conversation details by id 
